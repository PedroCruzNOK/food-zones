                ...
                <div class="row">	
                    <div class="col-md-5 col-md-offset-3 col-sm-12 text-right">
                        <div class="call_us_text">
                            <Link to ="/"><i class="fa fa-clock-o"></i> Order Foods 24/7</Link>
                            <Link to="/"><i class="fa fa-phone"></i>061 9876 5432</Link>
                        </div>
                    </div>
                </div>			
            </div>
                    ...
                    <nav class="navbar navbar-default">
                        <div class="container-fluid">
                            <div class="navbar-header">
                                ...
                                <Link to="/" class="navbar-brand our_logo" href="#"><img src="assets/images/logo.png" alt="" /></Link>
                            </div>
