      ...
      <div class="col-md-12">
        <div class="row justify-content-center">
          <div class="col-8 py-3">
            ...
            <p>
              <a class="btn btn-primary" data-bs-toggle="collapse" href="#multiCollapseExample1" role="button" aria-expanded="false" aria-controls="multiCollapseExample1">Aviso de Privacidad</a>
              <button class="btn btn-primary" type="button" data-bs-toggle="collapse" data-bs-target="#multiCollapseExample2" aria-expanded="false" aria-controls="multiCollapseExample2">Politica de proteccion de datos</button>
              <button class="btn btn-primary" type="button" data-bs-toggle="collapse" data-bs-target="#multiCollapseExample3" aria-expanded="false" aria-controls="multiCollapseExample3">Uso de cookies</button>
            ...
            <div class="row">
              <div class="col">
                <div class="collapse multi-collapse" id="multiCollapseExample1">
                  <div class="card card-body">
                    <h3 class=" wow animated rubberBand text-center py-3">Aviso de Privacidad</h3>
                    <p>Se necesita la creación del Aviso de Privicadad</p>
              ...
              <div class="col">
                <div class="collapse multi-collapse" id="multiCollapseExample2">
                  <div class="card card-body">
                    <h3 class="wow animated rubberBand text-center py-3">Política de Protección de Datos</h3>
                    <p>
                      Se necesita la creación del apartado Legal, enfocándonos en la
              ...
              <div class="col">
                <div class="collapse multi-collapse" id="multiCollapseExample3">
                  <div class="card card-body">
                    <h3 class="wow animated rubberBand text-center py-3">Uso de cookies</h3>
                    <h4 class="wow animated rubberBand  py-3">Politica de cookies</h4>
                    <p>
                    ...
                    <h5>Cookies utilizadas en este sitio</h5>
                    <p>
                    ...
                    <p>
                      ...
                      Para cualquier duda o consulta acerca de esta política de cookies no dude en comunicarse con nosotros mediante la dirección de correo contacto@iso25000.com.
                    </p>
                  </div>
                </div>
              </div>
